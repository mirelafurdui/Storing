<form action="{SITE_URL}/admin/product/deleteb/id/{ID}" method="post">
	<div class="box-shadow" style="width: 600px">
		...
		<ul class="form delete">
			...
			<li class="clearfix">
				...
				<input type="button" onclick="window.location = '{SITE_URL}/admin/product/brand'" class="button" value="Cancel">
			</li>
		</ul>
	</div>
</form>
